...
namespace Ocris.Views
{
    ...
    public partial class MainWindow : Window
    {
        ...
        /// 预览图片点击事件
        /// </summary>
        private void ImgPreview_Click(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            try
            {
                var viewModel = this.DataContext as MainViewModel;
                if (viewModel != null && viewModel.LockedAreaPreview != null)
                {
                    // 创建放大显示窗口
                    ...
                    {
                        Source = viewModel.LockedAreaPreview,
